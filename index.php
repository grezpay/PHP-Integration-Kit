...
define('PG_REQUEST_URL', 'http://uat.grezpay.com/crm/jsp/paymentrequest');
define('PG_RESPONSE_URL', 'http://uat.grezpay.com/crm/jsp/response.jsp');
...
<head>
    ...
    <title>Grezpay Demo Merchant Checkout Page</title>
        ...
        <form action="" method="post">
            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="MERCHANTNAME" class="signuptextfield" value="Grezpay Demo" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="ORDER_ID" class="signuptextfield" value="<?php echo 'GREZD'.date('dmyHi')?>" autocomplete="off" />
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_NAME" class="signuptextfield" value="GREZPAY DEMO" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>                   
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_EMAIL" class="signuptextfield" value="neeraj.kumar@grezpay.com" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
